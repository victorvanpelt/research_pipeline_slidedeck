...
-   Follow a template for a research pipeline ([**TIER Protocol**](https://www.projecttier.org/tier-protocol/protocol-4-0/)).
...
## 4. AI agents: Set the rules before it starts
